...
helm.sh/chart: {{ include "deployment-api.chart" . }}
{{ include "deployment-api.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- default (include "deployment-api.fullname" .) .Values.serviceAccount.name }}
{{- else }}
